/*
The chapter mentioned that an object’s hasOwnProperty can be used as a 
more robust alternative to the in operator when you want to ignore the 
...
console.log({map:true}.hasOwnProperty("map"));
// → true